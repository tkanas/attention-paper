% Perform no-leave-out data analysis
...
r2datashuf=1; % value of 1 means shuffled data will be analyzed
r2datasurr=1; % value of 1 means upper bound data will be analyzed
